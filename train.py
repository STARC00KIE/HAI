...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='resnet18', help='사용할 Timm 모델 이름')
    parser.add_argument('--img_size', type=int, default=384, help='입력 이미지 크기')
    ...
    parser.add_argument('--patience', type=int, default=5, help='Early stopping 기준')
...
if __name__ == "__main__":
    ...
    CFG['FILE_NAME'] = f"submission_{unique_name}"  # .csv 용
    CFG['CKPT_NAME'] = f"best_{unique_name}.pth"    # .pth 용
